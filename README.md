...
Leia o arquivo `GUIA_COMPLETO_EXPLICACAO.md` para entender cada parte do código e se preparar para apresentação.

---

**🎓 Projeto desenvolvido como trabalho acadêmico em dupla**